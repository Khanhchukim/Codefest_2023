...
void Game::updateMap(const std::vector<sio::message::ptr>& map, const std::vector<sio::message::ptr>& bombs, const int* power)
{    
    _mapGame.updateMap(map, bombs, power);
}
